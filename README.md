...
ชุดแบบฝึกหัดนี้พาเราสร้าง `ttb Service Request Assistant` ใน Microsoft Copilot Studio ตั้งแต่กำหนดโจทย์ เพิ่ม Knowledge สร้าง Agent Flow ไปจนถึงทดสอบและเผยแพร่ Agent อย่างรับผิดชอบ

> **ข้อมูลสำหรับการอบรม:** ชื่อบุคคล เหตุการณ์ ขั้นตอน และข้อมูลบริการทั้งหมดในชุดนี้เป็นข้อมูลสมมติ ไม่ใช่นโยบาย กระบวนการ หรือ SLA จริงของ ttb ห้ามใช้ข้อมูลลูกค้า ข้อมูลส่วนบุคคล หรือข้อมูลภายในจริงในการฝึก
...
- [ชุดกรณีทดสอบ](./files/service-request-test-cases.md)
