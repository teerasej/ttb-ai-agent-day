...
- ทำ [แบบฝึกหัดที่ 3](../exercise-03-add-agent-flow/README.md) แล้ว
- ดาวน์โหลดหรือเปิด [service-request-test-cases.md](../../files/service-request-test-cases.md)
- เปิด [agent-readiness-checklist.md](../../files/agent-readiness-checklist.md)
...
[แบบฝึกหัดก่อนหน้า](../exercise-03-add-agent-flow/README.md) | [กลับหน้าหลัก](../../README.md)
